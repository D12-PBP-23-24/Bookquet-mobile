...
import '../read_later/priority_selection.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: DropdownButton<String>(
                ...
                items: _genreChoices
                    .map<DropdownMenuItem<String>>((Map<String, String> genre) {
            ...
            FutureBuilder(
              ...
              builder: (context, AsyncSnapshot<List<Book>> snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return SizedBox(
                    height: (filteredBooks.length == 1)
                        ? filteredBooks.length * 500
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        int filledStars =
                            filteredBooks[index].fields.averageRate.round();
